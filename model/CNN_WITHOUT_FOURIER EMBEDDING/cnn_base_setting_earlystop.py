...
#   RMSE: 7.5135  MAE: 5.4552
# =======================================================
#   Day1  RMSE=6.5540  MAE=4.6985
#   Day2  RMSE=7.8570  MAE=5.7433
#   Day3  RMSE=8.1293  MAE=5.9238
import os
import sys
import warnings
import numpy as np
...
if __name__ == "__main__":
    ...
    BEST_PATH = "best_cnn_cams_timeembed_central.pth"; CKPT_PATH = "cnn_cams_timeembed_central_checkpoint.pth"
    ...
    save_predictions_csv("pred_cnn_timeembed_central.csv", P_3d, T_3d, C_3d,
